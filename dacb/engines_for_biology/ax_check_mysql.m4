...
#   flag designating where a MySQL installation is found.
#
#   AX_CHECK_MYSQL sets:
#
...
#    Copyright (c) Yusuke Tsutsumi <tsutsumi.yusuke@gmail.com>, Craig Stimmel <cstimmel@uw.edu>, Eric Wu
#
